...
class invoicePDF extends FPDF {
	...
	public function vatTotalAdd( $aLst = '' ) {
		if ( ! empty( $aLst ) ) {
			$this->vatTotalLst[] = $aLst;
		}
	}

	public function afterContentAdd( $aLst = '' ) {
		if ( ! empty( $aLst ) ) {
			$this->afterContent = $aLst;
		}
	}
	/**
	 ...
	 */
	private function buildLine( $aW, $aH, $aHeader = '', $aContent = '', $aTplt = '', $aColorF = array(
		'r' => 0,
		'g' => 0,
		'b' => 0,
	), $aColorBk = array(
